...
public class Alfil extends Ficha{
	...
	public Alfil(int y, int x, Jugador jug) {
		super(y, x);
		this.jug = jug;
		if(this.jug == Jugador.BLANCAS) { this.image = new ImageIcon("../Ajedrez/images/AlfilBlanco.png");}
		else { this.image = new ImageIcon("../Ajedrez/images/AlfilNegro.png");}
