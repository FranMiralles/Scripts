...
public class Torre extends Ficha{
	...
	public Torre(int y, int x, Jugador jug) {
		super(y, x);
		this.jug = jug;
		if(this.jug == Jugador.BLANCAS) { this.image = new ImageIcon("../Ajedrez/images/TorreBlanca.png");}
		else { this.image = new ImageIcon("../Ajedrez/images/TorreNegra.png");}
